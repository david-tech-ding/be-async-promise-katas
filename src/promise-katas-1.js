...
const returnPromise = async () => {
  try {
    ...
    console.error("The promise is expected to resolve")
  }
}
...
const returnBob = async () => {
  return await Promise.resolve({ name: "Bob" })
}
...
const returnList = async () => {
  return await Promise.resolve(["eggs", "apples", "milk", "bread"])
}
