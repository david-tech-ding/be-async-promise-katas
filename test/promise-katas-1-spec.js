...
describe("returnTen", () => {
  it("returns a promise that resolves to 10", (done) => {
    returnTen()
      ...
      .catch(() =>
        done(new Error("The promise is expected to resolve with 10!"))
      )
  })
})
...
describe("returnString", () => {
  it("returns a promise that resolves to 'string'", (done) => {
    returnString()
      ...
      .catch(() =>
        done(new Error("The promise is expected to resolve with 'string'!"))
      )
  })
})
  ...
  it("returns a promise that resolves to { name: 'Bob' }", (done) => {
    returnBob()
      ...
      .catch(() =>
          ...
          new Error("The promise is expected to resolve with { name: 'Bob' }!")
        )
      )
  })
})
  ...
  it("returns a promise that resolves to ['eggs', 'apples', 'milk', 'bread']", (done) => {
    returnList()
      ...
      .catch(() =>
          ...
          new Error(
            "The promise is expected to resolve with ['eggs', 'apples', 'milk', 'bread']!"
          )
        )
      )
  })
...
describe("theNumberOfTheBeast", () => {
  it("returns a promise that returns 666 when it rejects", (done) => {
    theNumberOfTheBeast().catch((value) => {
...
describe("internalServerError", () => {
  it("returns a promise that returns { error: 500 } when it rejects", (done) => {
    internalServerError().catch((value) => {
...
describe("happySad", () => {
  it('returns a promise that returns "happy" when x > 1', (done) => {
    happySad(2)
      ...
      .catch(() =>
        done(new Error("The promise is expected to resolve with happy!"))
      )
  })
  it('returns a promise that returns "happy" when x = 1', (done) => {
    happySad(1)
  ...
  it('returns a promise that returns "Yes. Luke, I am your father." when the passed parameter === "Luke"', (done) => {
    amIYourFather("Luke")
      ...
      .catch(() =>
          ...
          new Error(
            'The promise is expected to resolve with "Yes. Luke, I am your father."!'
          )
        )
      )
  })
  it('returns a promise that returns "Not your dad." when the passed parameter !== "Luke"', (done) => {
    amIYourFather("something else").catch((value) => {
      expect(value).to.equal("Not your dad.")
      done()
    })
  })
  it('returns a promise that returns "Not your dad." when the passed parameter !== "Luke"', (done) => {
    amIYourFather(0).catch((value) => {
      expect(value).to.equal("Not your dad.")
      done()
    })
  })
  ...
  it('returns a promise that returns "My name is Romy" when it resolves', (done) => {
    ...
    myNameIs()
      ...
      .catch(() =>
          ...
          new Error(
            'The promise is expected to resolve with a function that returns "My name is Romy"!'
          )
        )
      )
  })
